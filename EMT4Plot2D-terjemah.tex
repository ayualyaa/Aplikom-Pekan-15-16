...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-terjemah-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-010.png}
\begin{eulercomment}
...
(lihat di bawah untuk perintah figure()). style grid=0 tidak
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-027.png}
\eulersubheading{Fungsi dalam satu Parameter}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-terjemah-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D-terjemah-038.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-046.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-049.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-055.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-056.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-058.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-063.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-065.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-066.png}
\begin{eulercomment}
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-067.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-070.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-071.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-076.png}
\begin{eulercomment}
Ada juga kotak teks.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-077.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-078.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-079.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-080.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-081.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-082.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-083.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-084.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-085.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-087.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-090.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-091.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-092.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-094.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-095.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-096.png}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-098.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-099.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-100.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D-terjemah-103.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-104.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-105.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-106.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-108.png}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-109.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-110.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-111.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-112.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-113.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-114.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-115.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-116.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-118.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-119.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-120.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-123.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-124.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-125.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-127.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-129.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D-terjemah-131.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-132.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-133.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-134.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-136.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-137.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-138.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-139.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-140.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-141.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-142.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-144.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-145.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-146.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-147.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-148.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-150.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-151.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-152.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-153.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-154.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-155.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-156.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-157.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D-terjemah-158.png}
\eulerheading{Rujukan Lengkap Fungsi plot2d()}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerttcomment}
  fungsi plot2d (xv, yv, btest, a, b, c, d, xmin, xmax, r, n, ..
  logplot, kisi, bingkai, warna bingkai, kotak, warna, ketebalan,
\end{eulerttcomment}
\begin{eulercomment}
gaya, ..\\
\end{eulercomment}
\begin{eulerttcomment}
  otomatis, tambah, pengguna, delta, titik, titik tambahan, gaya
\end{eulerttcomment}
\begin{eulercomment}
titik,   batang, histogram, ..\\
\end{eulercomment}
\begin{eulerttcomment}
  distribusi, genap, langkah, milik, adaptif, rona, level, kontur, ..
  nc, terisi, warna isi, garis besar, judul, xl, yl, peta, warna
\end{eulerttcomment}
\begin{eulercomment}
kontur, ..\\
\end{eulercomment}
\begin{eulerttcomment}
  contourwidth, tick, margin, clipping, cx, cy, insimg, spectral, ..
  cgrid, vertikal, lebih kecil, dl, niveau, level)
\end{eulerttcomment}
\begin{eulercomment}

Fungsi plot serbaguna untuk plot dalam bidang (plot 2D). Fungsi ini
dapat membuat plot fungsi satu variabel, plot data, kurva pada bidang,
plot batang, grid bilangan kompleks, dan plot implisit fungsi dua
variabel.
...
square    : jika benar, usahakan untuk mempertahankan rentang x-y\\
n         : jumlah interval (standarnya adaptif)\\
grid      : 0 = tidak ada grid dan label,\\
\end{eulercomment}
\begin{eulerttcomment}
            1 = sumbu saja,
...
\end{eulercomment}
\begin{eulerttcomment}
            plot titik, itu harus berupa vektor kolom. Jika suatu
\end{eulerttcomment}
\begin{eulercomment}
vektor baris atau a\\
\end{eulercomment}
\begin{eulerttcomment}
            matriks warna penuh digunakan untuk plot titik, itu akan
\end{eulerttcomment}
\begin{eulercomment}
digunakan untuk\\
\end{eulercomment}
...
\end{eulerttcomment}
\begin{eulercomment}
poin      : memplot titik tunggal, bukan segmen garis\\
addpoints : jika benar, memplot segmen garis dan titik\\
add       : menambahkan plot ke plot yang sudah ada\\
pengguna  : mengaktifkan interaksi pengguna untuk fungsi\\
...
genap     : gunakan nilai antar untuk histogram otomatis.\\
langkah   : memplot fungsi sebagai fungsi langkah (langkah=1,2)\\
adaptif   : menggunakan plot adaptif (n adalah jumlah langkah minimal)\\
level     : memplot garis level dari fungsi implisit dua variabel\\
outline   : menggambar batas rentang level.

Jika nilai levelnya adalah matriks 2xn, maka rentang level akan
digambarkan dalam warna menggunakan gaya isian yang diberikan. Jika
garis besarnya benar, maka itu benar akan digambar dalam warna kontur.
Dengan menggunakan fitur ini, wilayah f(x,y) antar batas dapat
ditandai.

hue       : menambahkan warna rona ke plot level untuk menunjukkan
fungsinya\\
\end{eulercomment}
\begin{eulerttcomment}
            nilai
...
\end{eulercomment}
\begin{eulerttcomment}
  label vertikal secara lokal untuk satu plot. Nilai 1 hanya
\end{eulerttcomment}
\begin{eulercomment}
ditetapkan   secara vertikal\\
\end{eulercomment}
\begin{eulerttcomment}
...
\end{eulerttcomment}
\begin{eulercomment}
plot2d. Kisarannya akan ditentukan\\
\end{eulercomment}
\begin{eulerttcomment}
...
clipping     : mengaktifkan kliping (standarnya adalah true)\\
judul        :\\
\end{eulercomment}
\begin{eulerttcomment}
...
\end{eulercomment}
\begin{eulerttcomment}
  fungsi label() atau labelbox(). Judulnya bisa berupa unicode
...
\begin{eulerttcomment}
  ...
  Harus berupa pembagi ukuran matriks dikurangi 1 (jumlah
...
\end{eulerttcomment}
\begin{eulercomment}
menghitung nilai dalam rentang tertentu menggunakan fungsi atau
ekspresi tersebut. Ekspresinya harus berupa ekspresi dalam variabel x.
Rentang harus ditentukan dalam parameter a dan b kecuali rentang
default [-2,2] harus digunakan. Rentang y akan dihitung secara
otomatis, kecuali c dan d ditentukan, atau radius r, yang menghasilkan
rentang [-r,r] untuk x dan y. Untuk plot fungsi, plot2d akan
menggunakan evaluasi fungsi adaptif secara default. Untuk mempercepat
plot fungsi yang rumit, nonaktifkan ini dengan \textless{}adaptive, dan secara
opsional kurangi jumlah interval n. Selain itu, plot2d() secara
default akan menggunakan pemetaan. Yaitu, ini akan menghitung elemen
plot untuk elemen. Jika ekspresi atau fungsi Anda dapat menangani
vektor x, Anda dapat menonaktifkannya dengan \textless{}maps untuk evaluasi yang
lebih cepat.
...
sebagai koordinat y. Dalam hal ini, rentang harus ditentukan untuk
parameter menggunakan xmin, xmax. Ekspresi yang terdapat dalam string
harus selalu berupa ekspresi dalam variabel parameter x.
\end{eulercomment}
\begin{euleroutput}
...
\end{eulercomment}
\begin{eulerprompt}
>aspect(4); plot2d("x^2+y^2+2*x-4*y-4", level=0, contourcolor=blue):
\end{eulerprompt}
\eulerimg{6}{images/EMT4Plot2D-terjemah-159.png}
\begin{eulerprompt}
>plot2d("4*x^2+11*x-7", color=green):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-160.png}
\begin{eulerprompt}
>plot2d("3*x^2+4*x+1", color=yellow):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D-terjemah-161.png}
\eulerheading{Rujukan Lengkap Fungsi plot2d()}
\begin{eulercomment}
\end{eulercomment}
\begin{eulerttcomment}
