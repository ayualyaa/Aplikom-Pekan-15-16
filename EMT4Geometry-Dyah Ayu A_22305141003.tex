...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-003.png}
...
1. Titik singgung lingkaran dalam dengan sisi-sisi segitiga ABC.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-004.png}
\begin{eulercomment}
2. Gambar segitiga dengan titik-titik sudut ketiga titik singgung
tersebut. Merupakan segitiga apakah itu?
\end{eulercomment}
...
\end{eulerprompt}
\begin{eulercomment}
Segitiga dalam lingkaran tersebut merupakan segitiga sama sisi.
\end{eulercomment}
\begin{eulercomment}
3. Luas segitiga tersebut.
\end{eulercomment}
\begin{eulerprompt}
>norm(A-D)*norm(B-C)/2 // AD=norm(A-D), BC=norm(B-C)
\end{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-006-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-008-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-014-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-018.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-020.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-030.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-034-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-035.png}
\begin{eulercomment}
...
\begin{eulerformula}
\[
\left[ \left[ a=0 , b={\it \%r_3} \right]  \right] 
\]
\end{eulerformula}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-040-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-043.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-046-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-054.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-059.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-062.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-065-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-068-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-069.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-077-large.png}
\begin{eulercomment}
...
didefinisikan dalam file geometry.e Euler.
\end{eulercomment}
\begin{eulerprompt}
>$spread(a,b,c)
\end{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-081.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-084-large.png}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-085-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-088-large.png}
\begin{eulercomment}
Yaitu, fungsi penyebaran yang didefinisikan dalam "geometry.e".
\end{eulercomment}
\begin{eulerprompt}
>sb &= spread(b,a,c); $sb
\end{eulerprompt}
...
\end{eulerformula}
\begin{eulercomment}
Rumus determinan biasa memberikan hasil yang sama.
\end{eulercomment}
\begin{eulerprompt}
>$areaTriangle(B,A,C)
\end{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-096-large.png}
...
\end{eulerformula}
\begin{eulercomment}
sama, aturan triple spread juga berlaku, jika
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry-Dyah Ayu A_22305141003-104-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-106.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry-Dyah Ayu A_22305141003-108-large.png}
\eulerimg{1}{images/EMT4Geometry-Dyah Ayu A_22305141003-109-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-111.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-116.png}
\begin{eulercomment}
...
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Catatan pendahuluan}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-124.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-125.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-126.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-127.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-129.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-131.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-133.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-137.png}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-Dyah Ayu A_22305141003-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function povanaglyph not found.
  Try list ... to find functions!
  Error in:
  ... ",zoom=11,center=[0,0,0.5],height=10°,angle=140°); ...
                                                       ^
\end{euleroutput}
...
\end{eulerprompt}
\begin{eulercomment}
Sekarang kita tambahkan 10 kali sepersepuluh jarak, dengan menggunakan
judul Sekarang kita tambah 10 kali sepersepuluh jarak, pakai arah
Monas, kita sampai di Tugu.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Geometry-Dyah Ayu A_22305141003-139.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Geometry-Dyah Ayu A_22305141003-140.png}
