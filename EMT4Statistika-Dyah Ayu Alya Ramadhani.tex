...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-013.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-017.png}
\begin{eulercomment}
erikut adalah fungsi sederhana untuk memeriksa keseragaman distribusi
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-019.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-021.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-022.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-030.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-034.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-042.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-043.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-044.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-045.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
Di R ada paket untuk UnicodeStrings yang sama di R dan EMT. Keduanya
berada di lokal saat ini, bukan di Unicode.
...
sebaliknya. Selain itu, u"..." dapat berisi entitas HTML.. Dalam EMT,
string dapat berupa string Unicode. String unicode dapat diterjemahkan
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-048.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-049.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulerttcomment}
 jika writevar() digunakan pada suatu variabel, definisi variabel
\end{eulerttcomment}
\begin{eulercomment}
dengan nama variabel tersebut akan dicetak.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\eulerheading{Latihan Soal Lain}
\begin{eulercomment}
1. suatu kelompok belajar A yang terdiri dari 10 anggota telah selesai
mengerjakan sebuah soal matematika dan masing-masing memperoleh nilai
98,87,68,90,85,75,74,69,70,dan 88.\\
tentukan nilai tengah(media) dan rata-rata dari kelompok belajar
tersebut!
\end{eulercomment}
\begin{eulerprompt}
>A=[98,87,68,90,85,75,74,69,70,88]; ...
>median(A), mean(A)
\end{eulerprompt}
\begin{euleroutput}
  80
...
\end{euleroutput}
\begin{eulercomment}
sehingga diperoleh nilai tengah(median) dari data tersebut yaitu 80.\\
dan rata-rata nilai(mean) dari data tersebut yaitu 80,4
\end{eulercomment}
\begin{eulerprompt}
>aspect(1.5); boxplot(A):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-050.png}
\begin{eulercomment}
2. Membuat fungsi baru
\end{eulercomment}
\begin{eulerprompt}
>data=normal(15); skew(normal(10))
\end{eulerprompt}
\begin{euleroutput}
  -1.3365
\end{euleroutput}
...
\end{eulercomment}
\begin{eulerprompt}
>L=\{\{"Data Kelahiran","Siswa",40,[2002,2005]\}\}
\end{eulerprompt}
\begin{euleroutput}
  Data Kelahiran
  Siswa
...
>n:=1000; r:=random(1,n);
>a:=0.05; d:=differences(nonzeros(r<a));
>m=getmultiplicities(1:10,d); plot2d(m); ...
>  plot2d("n*(1-a)^(x-1)*a^2",color=red,>add):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Statistika-Dyah Ayu Alya Ramadhani-051.png}
\begin{eulercomment}
5.
\end{eulercomment}
\begin{eulerprompt}
>D=[798, 980, 809, 435, 786, 423, 790, 679, 509, 242, 658]
\end{eulerprompt}
\begin{euleroutput}
  [798,  980,  809,  435,  786,  423,  790,  679,  509,  242,  658]
\end{euleroutput}
\begin{eulerprompt}
>mean(D)
\end{eulerprompt}
